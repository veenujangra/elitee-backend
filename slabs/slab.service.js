...
async function getAll() {
    console.log('slabs getAll calling:');
    return await Insurer.find().sort({ createdAt: -1 });
}
...
async function getAllActive() {
    console.log('slabs getAllActive calling:');
...
async function getAllById(id) {
    console.log('slabs getAllById calling:');
